...
// Memoize the Analytics component to prevent expensive re-renders when the parent App component
// updates due to high-frequency liveStats changes. It only depends on 'stats'.
