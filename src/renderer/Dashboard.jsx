...
export default function Dashboard({ stats, liveStats, onNavigate }) {
  // Memoize all expensive derived data that only depends on `stats`.
  // liveStats updates frequently (multiple times per second), so memoization prevents
  // recomputing lists, filtering sessions, mapping dates, and calculating complex SVG wave paths
